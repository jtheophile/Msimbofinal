    ...
    render() {
        ...
        return (
            <div className="container text-center">
                <br></br>
                <p>Support POC Businesses & Organizations | Collaborate on Projects & Find Talent</p>
                ...
                <div className="input-group">
                    <input
                        ...
                        < button onClick={this.filterAllUsersData} className="btn btn-success btn-block outline-secondary" type="btn">Search - we got what your looking for :)</ button>
